  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Welcome to Neuvia${signupType === "doctor" ? ", Doctor" : ""}!`,
      });
      ...
      <Card className="w-full max-w-md bg-warm-white backdrop-blur-sm shadow-xl animate-fade-in border-warm">
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="phoneNumber" className="text-primary">Phone Number *</Label>
              <Input
                id="phoneNumber"
                type="tel"
            ...
            {signupType === "doctor" && (
              <>
                <div className="space-y-2">
                  <Label htmlFor="specialization" className="text-primary">Specialization *</Label>
                  <Input
                    id="specialization"
                    type="text"
                ...
                <div className="space-y-2">
                  <Label htmlFor="licenseNumber" className="text-primary">Medical License Number *</Label>
                  <Input
                    id="licenseNumber"
                    type="text"
                ...
                <div className="space-y-2">
                  <Label htmlFor="hospital" className="text-primary">Hospital/Clinic *</Label>
                  <Input
                    id="hospital"
                    type="text"
            ...
            >
              ...
              `}</style>
              {loading ? "Creating Account..." : `Create ${signupType === "doctor" ? "Doctor" : "Patient"} Account`}
            </Button>
          </form>
